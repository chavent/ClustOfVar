...
#' @return \item{var}{a list of matrices of squared loadings i.e. for each cluster of variables, the squared loadings on first principal component of PCAmix.
...
#' @return \item{sim}{a list of matrices of similarities i.e. for each cluster, similarities between their variables. 
...
#' @return \item{cluster}{a vector of integers indicating the cluster to which each variable is allocated.}
#' @return \item{wss}{the within-cluster sum of squares for each cluster: the sum of the correlation ratio (for qualitative variables) and the squared correlation (for quantitative variables) between the variables and the center of the cluster.}
#' @return \item{E}{the pourcentage of  homogeneity which is accounted by the partition in k clusters.}
#' @return \item{size}{the number of variables in each cluster.}
#' @return \item{scores}{a n by k numerical matrix which contains the k cluster centers. The center of a cluster is a synthetic variable: the first principal component calculated by PCAmix. 
#' The k columns of \code{scores} contain the scores of the n observations units on the first PCs of the k clusters.}
#' @return \item{coef}{a list of the coefficients of the linear combinations defining the synthetic variable of each cluster.}
#' @keywords internal
